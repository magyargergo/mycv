...
const Education: React.FC = () => (
    <div id="education" className="flex flex-1 flex-col pt-6 sm:pt-8 md:pt-12">
        <div className="px-4 sm:px-6 flex items-center mb-4 sm:mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-blue-700">Education</h2>
        </div>
            ...
            <div className="border-l-2 sm:border-l-4 border-blue-200 ml-3 sm:ml-4">
                ...
                <div className="mb-6 sm:mb-8 relative">
                    ...
                    <div className="ml-4 sm:ml-6">
                        <h3 className="text-xl sm:text-2xl font-semibold text-gray-800">Corvinus University of Budapest</h3>
                        <p className="text-sm sm:text-base text-gray-600">Master&apos;s Degree, Economist in Accountancy</p>
                ...
                <div className="mb-6 sm:mb-8 relative">
                    ...
                    {/* Institution Header */}
                    <div className="ml-4 sm:ml-6">
                        <h3 className="text-xl sm:text-2xl font-semibold text-gray-800">University of Szeged</h3>
                        <p className="text-sm sm:text-base text-gray-600">Bachelor&apos;s Degree, Computer Science</p>
                ...
                <div className="mb-6 sm:mb-8 relative">
                    ...
                    {/* Institution Header */}
                    <div className="ml-4 sm:ml-6">
                        <h3 className="text-xl sm:text-2xl font-semibold text-gray-800">József Attila Secondary Grammar School</h3>
                        <p className="text-sm sm:text-base text-gray-600">High School Diploma, Mathematics and Informatics Faculty</p>
