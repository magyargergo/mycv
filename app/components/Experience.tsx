...
const Experience: React.FC = () => (
    <div id="experience" className="flex flex-1 flex-col pt-6 sm:pt-8 md:pt-12">
            ...
            <div className="border-l-2 sm:border-l-4 border-blue-200 ml-3 sm:ml-4">
                ...
                <div className="mb-6 sm:mb-8 relative">
                    ...
                    <div className="flex flex-col justify-center ml-4 sm:ml-6">
                        <h3 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3">Freelancer
                            Outsourcing UK Limited</h3>
                        <div
                            className="inline-flex items-center bg-blue-100 text-blue-700 px-3 py-1 rounded-full w-auto">
                    ...
                    <div className="mt-4 mb-4 sm:mb-6 ml-4 sm:ml-6">
                        ...
                        <ul className="list-disc ml-4 sm:ml-6 text-gray-700 text-sm sm:text-base text-justify">
                            <li>Led platform stability and optimization initiatives, effectively managing incident
                                response and root cause analysis, resulting in a reduction of critical incidents by 25%.
                            </li>
                    ...
                    <div className="mb-4 sm:mb-6 ml-4 sm:ml-6">
                        ...
                        <ul className="list-disc ml-4 sm:ml-6 text-gray-700 text-sm sm:text-base text-justify">
                            ...
                            <li>Optimized existing features and integrated new ones using Angular, PHP, and Python, improving system performance by 15%.</li>
                ...
                <div className="mb-6 sm:mb-8 relative">
                    ...
                    {/* Company Header */}
                    <div className="flex flex-col justify-center ml-4 sm:ml-6">
                        <h3 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3">Fornax Kft.
                            (Hungary)</h3>
                        <div
                            className="inline-flex items-center bg-blue-100 text-blue-700 px-3 py-1 rounded-full w-auto">
                            <FaClock className="mr-2 text-sm"/>
                    ...
                    <div className="mt-4 mb-4 sm:mb-6 ml-4 sm:ml-6">
                        ...
                        <ul className="list-disc ml-4 sm:ml-6 text-gray-700 text-sm sm:text-base text-justify">
                            <li>Implemented Keycloak SSO for backend security and OAuth2 for frontend authentication,
                            ...
                            <li>Maintained and optimized graph and relational databases (AgensGraph and PostgreSQL), improving data retrieval efficiency by 20%.</li>
                            <li>Standardized frontend development processes and mentored junior developers, improving team productivity.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="mb-6 sm:mb-8 relative">
                    ...
                    {/* Company Header */}
                    <div className="flex flex-col justify-center ml-4 sm:ml-6">
                        <h3 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3">Minero IT Hungary
                            Kft.</h3>
                        <div
                            className="inline-flex items-center bg-blue-100 text-blue-700 px-3 py-1 rounded-full w-auto">
                            <FaClock className="mr-2 text-sm"/>
                            <span
                                className="text-sm font-medium whitespace-nowrap">Total Duration: 2 years 6 months</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-4 mb-4 sm:mb-6 ml-4 sm:ml-6">
                        ...
                        <ul className="list-disc ml-4 sm:ml-6 text-gray-700 text-sm sm:text-base text-justify">
                            <li>Collaborated with international teams to design and extend a specialized Java compiler,
                    ...
                    <div className="mb-4 sm:mb-6 ml-4 sm:ml-6">
                        ...
                        <ul className="list-disc ml-4 sm:ml-6 text-gray-700 text-sm sm:text-base text-justify">
                            ...
                            <li>Supported the implementation of a specialized IDE featuring refactoring capabilities.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="mb-6 sm:mb-8 relative">
                    ...
                    {/* Company Header */}
                    <div className="flex flex-col justify-center ml-4 sm:ml-6">
                        <h3 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3">FrontEndART
                            Software Ltd.</h3>
                        <div
                            className="inline-flex items-center bg-blue-100 text-blue-700 px-3 py-1 rounded-full w-auto">
                            <FaClock className="mr-2 text-sm"/>
                            <span
                                className="text-sm font-medium whitespace-nowrap">Total Duration: 2 years 3 months</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-4 mb-4 sm:mb-6 ml-4 sm:ml-6">
                        ...
                        <ul className="list-disc ml-4 sm:ml-6 text-gray-700 text-sm sm:text-base text-justify">
                            <li>Transformed FxCop analysis results into user-friendly reports, improving usability and
                                developer adoption.
                            </li>
                    ...
                    <div className="mb-4 sm:mb-6 ml-4 sm:ml-6">
                        ...
                        <ul className="list-disc ml-4 sm:ml-6 text-gray-700 text-sm sm:text-base text-justify">
                            <li>Developed a static code analysis tool in C# using the Roslyn compiler infrastructure,
